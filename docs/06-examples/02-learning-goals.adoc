...
// LG-title-proposal: Analyze practical examples of architecture documentation
// LG-title-proposal: Evaluate examples of architecture documentation
// LG-title-proposal: Explain pros and cons of sample architecture documentation
