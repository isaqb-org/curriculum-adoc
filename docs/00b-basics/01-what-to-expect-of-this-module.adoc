...
Behandelt die Auswahl und den Einsatz von Werkzeugen für die Dokumentationsarbeit.
Sie lernen Anforderungen an Dokumentationswerkzeuge zu definieren, den Docs-As-Code Ansatz kennen und GenAI-Werkzeuge als Unterstützung für die Architekturdokumentation anzuwenden.

==== 05 – Dokumentation bewerten

Beschreibt, wie Architekturdokumentation auf Gebrauchstauglichkeit überprüft werden kann.
...
You learn to define requirements for documentation tools, get to know the Docs-As-Code approach, and apply GenAI tools to support architecture documentation.
