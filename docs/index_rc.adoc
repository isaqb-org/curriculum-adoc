...
The **Release Candidates** of the **Advanced Level Module ADOC** curriculum are currently maintained and published in both English (EN) and German (DE). Maintainers of this curriculum and voluntary reviewers collaborate on https://github.com/isaqb-org[GitHub] to improve the curriculum.
...
image:https://img.shields.io/github/commits-since/isaqb-org/curriculum-adoc/latest.svg[]
|===
| Version | HTML | PDF
...
- link:https://github.com/isaqb-org/curriculum-adoc/blob/main/CHANGELOG.md[CHANGELOG.md on GitHub]
