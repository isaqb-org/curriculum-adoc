...
== Status
image:https://github.com/isaqb-org/curriculum-adoc/actions/workflows/pages/pages-build-deployment/badge.svg["CI – Build-and-Deploy"]
...
| 2025.1  | 2025 | Updated references, included docs-as-code, included LLMs/AI (see changelog.md for details). Consistent wording for learning goals.
| 2021.1  | 2021 | Major content overhaul, migrating to AsciiDoc, first English version. Several updated learning goals. 
| 1.6-DE  | 2018 | Minor fixes, not sync'ed with EN version
| 1.5-EN  | 2018 | Preliminary translation
| 1.5-DE  | 2018 | Minor update of German version
|===
